...
class Ui_EqDistantDockWidgetBase(object):
    def setupUi(self, EqDistantDockWidgetBase):
        ...
        EqDistantDockWidgetBase.resize(525, 766)
        ...
        self.eq_distant_tab = QtWidgets.QWidget()
        self.eq_distant_tab.setObjectName("eq_distant_tab")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.eq_distant_tab)
        self.verticalLayout.setObjectName("verticalLayout")
        self.groupBox = QtWidgets.QGroupBox(self.eq_distant_tab)
        ...
        self.gridLayout.addLayout(self.gridLayout_5, 6, 0, 1, 1)
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.label_3 = QtWidgets.QLabel(self.groupBox)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_5.addWidget(self.label_3)
        self.single_input = QtWidgets.QRadioButton(self.groupBox)
        self.single_input.setObjectName("single_input")
        self.horizontalLayout_5.addWidget(self.single_input)
        self.multi_input = QtWidgets.QRadioButton(self.groupBox)
        self.multi_input.setChecked(True)
        self.multi_input.setObjectName("multi_input")
        self.horizontalLayout_5.addWidget(self.multi_input)
        self.gridLayout.addLayout(self.horizontalLayout_5, 0, 0, 1, 1)
        self.verticalLayout.addWidget(self.groupBox)
        self.outputGroup = QtWidgets.QGroupBox(self.eq_distant_tab)
        ...
        self.tabWidget.addTab(self.eq_distant_tab, "")
        self.map_tools_tab = QtWidgets.QWidget()
        self.map_tools_tab.setObjectName("map_tools_tab")
        self.tabWidget.addTab(self.map_tools_tab, "")
        ...
        self.single_input.toggled['bool'].connect(self.multi_input.toggle)
        self.multi_input.toggled['bool'].connect(self.single_input.toggle)
    ...
    def retranslateUi(self, EqDistantDockWidgetBase):
        ...
        self.label_3.setText(_translate("EqDistantDockWidgetBase", "Input Mode"))
        self.single_input.setText(_translate("EqDistantDockWidgetBase", "Single file input"))
        self.multi_input.setText(_translate("EqDistantDockWidgetBase", "Multiple files input"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.eq_distant_tab), _translate("EqDistantDockWidgetBase", "EqDistant"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.map_tools_tab), _translate("EqDistantDockWidgetBase", "Map Tools"))
