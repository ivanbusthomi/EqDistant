...
# '/Users/ivanbusthomi/Library/Application Support
# /QGIS/QGIS3/profiles/default/python/plugins/EqDistant
# /eq_distant_dockwidget_base.ui'
#
...
class Ui_EqDistantDockWidgetBase(object):
    def setupUi(self, EqDistantDockWidgetBase):
        ...
        sizePolicy.setHeightForWidth(
            self.interpolate_value_a.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.interpolate_unit_a.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.interpolate_unit_b.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.interpolate_value_b.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.outputGroup.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.buffer_value.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.buffer_unit.sizePolicy().hasHeightForWidth()
        )
        ...
        self.rb_saveToFolder.toggled['bool'].connect(
            self.folder_path.setEnabled
        )
        self.rb_saveToFolder.toggled['bool'].connect(
            self.btn_browse_dir.setEnabled
        )
        self.interpolate_input_a.toggled['bool'].connect(
            self.interpolate_value_a.setEnabled
        )
        self.interpolate_input_a.toggled['bool'].connect(
            self.interpolate_unit_a.setEnabled
        )
        self.interpolate_input_b.toggled['bool'].connect(
            self.interpolate_value_b.setEnabled
        )
        self.interpolate_input_b.toggled['bool'].connect(
            self.interpolate_unit_b.setEnabled
        )
        self.rb_saveToFolder.toggled['bool'].connect(
            self.check_load_result.setEnabled
        )
        QtCore.QMetaObject.connectSlotsByName(EqDistantDockWidgetBase)

    def retranslateUi(self, EqDistantDockWidgetBase):
        _translate = QtCore.QCoreApplication.translate
        EqDistantDockWidgetBase.setWindowTitle(
            _translate("EqDistantDockWidgetBase", "EqDistant")
        )
        self.groupBox.setTitle(
            _translate("EqDistantDockWidgetBase", "Input")
        )
        self.interpolate_value_a.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Interval distance. Line segment shorter than this value" /
                " will be interpolated."
            )
        )
        self.interpolate_input_a.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Interpolate point at a given interval. Enabled on input" /
                " layer in Projected CRS."
            )
        )
        self.interpolate_input_a.setText(
            _translate("EqDistantDockWidgetBase", "Interpolate point")
            )
        self.interpolate_unit_a.setItemText(
            0,
            _translate("EqDistantDockWidgetBase", "Meter"))
        self.interpolate_unit_a.setItemText(
            1,
            _translate("EqDistantDockWidgetBase", "Kilometer"))
        self.interpolate_unit_a.setItemText(
            2,
            _translate("EqDistantDockWidgetBase", "Nautical Miles"))
        self.selected_input_a.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Only use selected features in this layer as input for line "
                " creation."
            )
        )
        self.selected_input_a.setText(
            _translate("EqDistantDockWidgetBase", "Selected features only"))
        self.label.setText(
            _translate("EqDistantDockWidgetBase", "Input Layer A"))
        self.btn_preprocess.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Preprocess input data to get initial overview on the area."
            )
        )
        self.btn_preprocess.setText(
            _translate("EqDistantDockWidgetBase", "Preprocess"))
        self.label_2.setText(
            _translate("EqDistantDockWidgetBase", "Input Layer B"))
        self.interpolate_unit_b.setItemText(
            0, _translate("EqDistantDockWidgetBase", "Meter"))
        self.interpolate_unit_b.setItemText(
            1, _translate("EqDistantDockWidgetBase", "Kilometer"))
        self.interpolate_unit_b.setItemText(
            2, _translate("EqDistantDockWidgetBase", "Nautical Miles"))
        self.selected_input_b.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Only use selected features in this layer as input for line "
                "creation."
        ...
        self.selected_input_b.setText(
            _translate(
                "EqDistantDockWidgetBase",
                "Selected features only"))
        self.interpolate_value_b.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Interval distance. Line segment shorter than this value will "
                "be interpolated."
            )
        )
        self.interpolate_input_b.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Interpolate point at a given interval. Enabled on input "
                "layer in Projected CRS."
        ...
        self.interpolate_input_b.setText(
            _translate("EqDistantDockWidgetBase", "Interpolate point")
        )
        self.outputGroup.setTitle(
            _translate("EqDistantDockWidgetBase", "Output")
        )
        self.label_10.setText(
            _translate(
                "EqDistantDockWidgetBase",
                "Directory"))
        self.btn_browse_dir.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Browse for folder to save the results layer."))
        ...
        self.label_11.setText(
            _translate(
                "EqDistantDockWidgetBase",
                "Output Option"))
        self.check_median_line.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Median / Equidistant line"))
        self.check_median_line.setText(
            _translate(
                "EqDistantDockWidgetBase",
                "Median Line"))
        self.check_construction_line.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Construction line indicates which point in the input layer "
                "that is used in creating the median line."
            )
        )
        self.check_construction_line.setText(
            _translate("EqDistantDockWidgetBase", "Construction Line")
        )
        self.check_equidistant_point.setToolTip(
            _translate("EqDistantDockWidgetBase", "Equidistant point")
        )
        self.check_equidistant_point.setText(
            _translate("EqDistantDockWidgetBase", "Equidistant Point")
        )
        self.check_load_result.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Construction line indicates which point in the input layer "
                "that is used in creating the median line."
        ...
        self.check_load_result.setText(
            _translate("EqDistantDockWidgetBase", "Load results")
        )
        self.label_13.setText(
            _translate("EqDistantDockWidgetBase", "Output Location")
        )
        self.rb_saveToFolder.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Save the final results in local folder."
            )
        )
        self.rb_saveToFolder.setText(
            _translate("EqDistantDockWidgetBase", "Save to local folder"))
        self.rb_saveAsTemporary.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Save the final results as memory layer."
            )
        )
        self.rb_saveAsTemporary.setText(
            _translate("EqDistantDockWidgetBase", "as temporary file"))
        self.check_final_boundary.setToolTip(
            _translate("EqDistantDockWidgetBase", "Equidistant point"))
        self.check_final_boundary.setText(
            _translate("EqDistantDockWidgetBase", "Generate Boundary"))
        self.buffer_value.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Interval distance. Line segment shorter than this value will "
                "be interpolated."
        ...
        self.buffer_unit.setItemText(
            0, _translate("EqDistantDockWidgetBase", "Meter"))
        self.buffer_unit.setItemText(
            1, _translate("EqDistantDockWidgetBase", "Kilometer"))
        self.buffer_unit.setItemText(
            2, _translate("EqDistantDockWidgetBase", "Nautical Miles"))
        self.check_debug_mode.setToolTip(
            _translate(
                "EqDistantDockWidgetBase",
                "Export all intermediate results to the layer list as memory "
                "layers."
            )
        )
        self.check_debug_mode.setText(
            _translate("EqDistantDockWidgetBase", "Debug Mode"))
        self.btn_help.setText(
            _translate("EqDistantDockWidgetBase", "Help"))
        self.btn_clear.setToolTip(
            _translate("EqDistantDockWidgetBase", "Clear all input."))
        self.btn_clear.setText(
            _translate("EqDistantDockWidgetBase", "Clear"))
        self.btn_process.setText(
            _translate("EqDistantDockWidgetBase", "Process"))
        # self.pushButton.setText(
        #     _translate("EqDistantDockWidgetBase", "Custom Button"))
